...
export default function Home() {
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-emerald-950 text-emerald-50"
      style={{
        fontFamily:
    ...
    >
      <div className="mx-auto flex min-h-screen max-w-5xl flex-col px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="flex-1 rounded-3xl border border-emerald-500/30 bg-emerald-900/20 shadow-[0_0_60px_rgba(6,95,70,0.6)] backdrop-blur-xl">
          <div className="flex h-[700px] flex-col overflow-hidden rounded-3xl">
            ...
            {/* Message membrane */}
            <div className="flex-1 space-y-4 overflow-y-auto bg-gradient-to-b from-emerald-950/40 via-slate-950/60 to-emerald-950/80 px-4 py-4">
              ...
              <form onSubmit={handleSubmit} className="flex items-center gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    placeholder={
                      isListening ? '>>> Live transcription: speak into the membrane' : 'Type into the membrane...'
                    }
